        ...
        <div className="mt-14 grid gap-6">
          {featured && (
            <ScrollReveal className="block">
              <TiltCard className="group relative overflow-hidden rounded-[2rem] border border-primary/15 bg-surface/90 p-8 shadow-[0_40px_120px_rgba(0,0,0,0.28)] transition-all duration-200 hover:shadow-[0_50px_140px_rgba(229,178,93,0.18)]">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            {rest.map((project, i) => (
              <ScrollReveal key={project.title} delay={i * 80} className="block">
                <TiltCard className="group flex h-full flex-col rounded-[1.75rem] glass p-6 border border-white/10 transition-all duration-200 hover:border-primary/25 hover:shadow-[0_28px_90px_rgba(229,178,93,0.12)]">
